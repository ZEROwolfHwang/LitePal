...
public class ResultMovieBean<T> {
    ...
    public static ResultMovieBean objectFromData(String str) {

        return new Gson().fromJson(str, ResultMovieBean.class);
    }
    ...
    public static class SubjectsEntity {
        ...
        public static class CastsEntity {
            ...
            public static class AvatarsEntity {
                ...
                public static AvatarsEntity objectFromData(String str) {

                    return new Gson().fromJson(str, AvatarsEntity.class);
                }
        ...
        public static class DirectorsEntity {
            ...
            public static class AvatarsEntityX {
                ...
                public static AvatarsEntityX objectFromData(String str) {

                    return new Gson().fromJson(str, AvatarsEntityX.class);
                }
